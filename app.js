...
function renderWeeklyChart(cySeries, lySeries) {
  ...
  const datasets = [
    {
      ...
      backgroundColor: GOLD, borderRadius: 4, order: 3, yAxisID: "y",
      datalabels: {
    ...
    {
      type: "line", label: "Ach % (This Year)", data: achCY, borderColor: PLUM, backgroundColor: PLUM,
      borderWidth: 2.5, pointRadius: 4, pointHoverRadius: 6, pointBackgroundColor: PLUM,
  ...
  if (hasLY) {
    datasets.push({
      type: "line", label: "Ach % (Last Year)", data: achLY, borderColor: "#8A96A3", backgroundColor: "#8A96A3",
      borderWidth: 2, borderDash: [5, 4], pointRadius: 3, pointHoverRadius: 5, pointBackgroundColor: "#8A96A3",
